...
function nextDemo() {
    ...
    switch (demoNumber) {
        ...
        case 6:
            ...
            document.getElementById("policajt").addEventListener("click", function (event) {
                console.log(event);
            ...
            break;
        case 7:
            document.addEventListener("mousemove", chchrmchr => {
                document.getElementById("axis-x").textContent = chchrmchr.clientX;
                document.getElementById("axis-y").textContent = chchrmchr.clientY;
                document.body.style.backgroundColor = `rgb(${chchrmchr.clientX % 255}, ${chchrmchr.clientY % 255}, 150)`;
            });
